package org.smartregister.chw.familyPlanning.provider;
...
public class BaseFamilyPlanningRegisterProvider implements RecyclerViewProvider<BaseFamilyPlanningRegisterProvider.RegisterViewHolder> {
    ...
    public BaseFamilyPlanningRegisterProvider(Context context, View.OnClickListener paginationClickListener) {
