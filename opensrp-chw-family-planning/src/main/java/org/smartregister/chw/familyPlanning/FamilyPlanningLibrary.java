package org.smartregister.chw.familyPlanning;
...
public class FamilyPlanningLibrary {
    private static FamilyPlanningLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new FamilyPlanningLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static FamilyPlanningLibrary getInstance() {
        if (instance == null) {
    ...
    private FamilyPlanningLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
