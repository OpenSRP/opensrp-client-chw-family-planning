...
import org.smartregister.chw.familyPlanning.util.ConfigHelper;
...
public class BaseFamilyPlanningRegisterFragmentModel implements BaseFamilyPlanningRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(FamilyPlanningLibrary.getInstance().context().applicationContext());
    }
